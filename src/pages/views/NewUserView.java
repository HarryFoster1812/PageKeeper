...
public class NewUserView {
    ...
    public NewUserView(NewUserController controller) {
        ...
        continueButton.setStyle(
                "-fx-background-color: #ed6343; -fx-background-radius: 25.5px; -fx-text-fill: #ffffff; -fx-pref-height:65px; -fx-pref-width:245px; -fx-font-size:24;");
